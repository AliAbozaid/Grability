 ...
 */
public class ProductsInteractorImpl2 extends UseCase implements ResponseCallback {
    ...
    public ProductsInteractorImpl2(Retrofit retrofit, String url, ResponseCallback.MYCallback mCallback, MainPresenter.PresenterCallBack presenterCallBack) {
    ...
    private final class ProductSubscriber extends DefaultSubscriber<ListOfProductsModel> {
        ...
        @Override public void onNext(ListOfProductsModel listOfProductsModel) {
